...
function onUpdatePost(elapsed)
    setProperty("botplayTxt.text", "Cheater detected")
    setPropertyFromClass("openfl.Lib", "application.window.title", "OPPOSITION.exe")
end

function onCreatePost()
  setProperty('scoreTxt.visible', true)
    setProperty('botplayTxt.color', getColorFromHex('FFD800'))
  end
