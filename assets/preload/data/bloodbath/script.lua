...
function onUpdate(elapsed)
    ...
    currentBeat = (songPos / 350) * (bpm / 170) --this is basically speed, idk how to adjust it

    if curStep >= 767 and curStep < 1040 then
    ...
    if curStep == 1040 then --this is to revert back to original position
        for i = 0,7 do 
